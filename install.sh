sudo apt update && sudo apt install -y htop git zip 7zip unzip tmux zsh curl wget ffmpeg libreoffice vlc build-essential flatpak ca-certificates gnupg gimp inkscape variety indicator-multiload ttf-mscorefonts-installer
